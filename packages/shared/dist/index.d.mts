...
export type { SpeechRecognitionResult, SpeechRecognitionOptions, SpeechRecognitionCallbacks } from './lib/services/speechService.js';
export { VOICE_OPTIONS, DEFAULT_TEXTS, VoiceType, getDefaultTextByVoiceType, isStartVoiceText, getVoiceLabelByType, } from './lib/constants/voiceConfig.js';
