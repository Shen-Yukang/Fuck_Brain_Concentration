 ...
 * 验证语音服务基本功能
 */
export function validateVoiceService() {
    try {
 ...
 * 验证状态管理
 */
export function validateStateManagement() {
    try {
        console.log('🔍 验证状态管理...');
        // 验证所有状态都有转换规则
...
export function validateConstants() {
    try {
        ...
        for (const constant of requiredVoiceConstants) {
            ...
            if (typeof VOICE_CONSTANTS[constant] !== 'number') {
        ...
        for (const constant of requiredRecognitionConstants) {
            ...
            if (typeof RECOGNITION_CONSTANTS[constant] !== 'number') {
