...
(function (VoiceType) {
    VoiceType["ZH_FEMALE_LINJIANVHAI"] = "zh_female_linjianvhai_moon_bigtts";
    VoiceType["ZH_FEMALE_YUANQINVYOU"] = "zh_female_yuanqinvyou_moon_bigtts";
    VoiceType["ZH_FEMALE_GAOLENGYUJIE"] = "zh_female_gaolengyujie_moon_bigtts";
    VoiceType["ZH_FEMALE_TIANMEIXIAOYUAN"] = "zh_female_tianmeixiaoyuan_moon_bigtts";
    VoiceType["ZH_FEMALE_KAILANGJIEJIE"] = "zh_female_kailangjiejie_moon_bigtts";
    VoiceType["MULTI_FEMALE_SHUANGKUAISISI"] = "multi_female_shuangkuaisisi_moon_bigtts";
    VoiceType["MULTI_FEMALE_GAOLENGYUJIE"] = "multi_female_gaolengyujie_moon_bigtts";
})(VoiceType || (VoiceType = {}));
// 默认文本常量
 ...
 * 根据语音类型获取默认文本
 */
export function getDefaultTextByVoiceType(voiceType) {
 ...
 * 有点 hacky，但是目前应该够用了
 */
export function isStartVoiceText(text) {
    return (text.includes('专注模式已启动') ||
        text.includes('开始专注') ||
 ...
 * 获取语音选项的标签
 */
export function getVoiceLabelByType(voiceType) {
    const voiceOption = VOICE_OPTIONS.find(option => option.value === voiceType);
