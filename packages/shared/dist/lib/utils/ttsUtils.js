...
export class TTSTextProcessor {
     ...
     */
    static getStartVoiceText(ttsConfig) {
...
export class TTSCacheManager {
     ...
     * 生成缓存键
     */
    static generateCacheKey(voiceType, text) {
...
export class TTSConfigValidator {
     ...
     * 验证语速比例
     */
    static validateSpeedRatio(speedRatio) {
